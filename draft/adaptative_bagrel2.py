...
"""Adaptative Bagrel2 compression algorithm."""


class Node(object):
    """Node for the adaptative Bagrel2 structure."""
...
class AdaptativeHuffmanStructure(object):
    """Tree-like structure used to store the adaptative Bagrel2 tree."""
    ...
    def code(self, value):
        """Codes the specified value according to the adaptative Bagrel2
        algorithm."""
